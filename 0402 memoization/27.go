...
const FILE LineFile = "27.txt"
const LOCK_FILE = "27.lock"
...
func NewLockFile(s string) *LockFile {
  f, _ := os.OpenFile(s, os.O_CREATE | os.O_RDONLY, 0444)
  return &LockFile{ f }
}

func (l *LockFile) Flock(i int) {
  if l.File != nil {
    syscall.Flock(int(l.Fd()), i)
  }
}
