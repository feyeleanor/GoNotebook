...
func payloadWithLimitedRuns(l int) Payload {
  i := l
  return func() (ok bool) {
    if ok = i > 0; ok {
      WriteToFile(i, func() {
...
func main() {
  ...
  s.CueTask("A", payloadWithLimitedRuns(4))
  s.CueTask("B", payloadWithLimitedRuns(4))
  s.CueTask("C", payloadWithLimitedRuns(4))
  s.Run()
  s.Run()
}
